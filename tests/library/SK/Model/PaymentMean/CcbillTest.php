...
class SK_Model_PaymentMean_CcbillTest extends SKTest_TestCase {

    /** @var SK_User $_user */
    private $_user;

    /** @var SK_Model_PaymentMean_Ccbill $_paymentMean */
    private $_paymentMean;

    public function setUp() {
        $this->_user = SKTest_TH::createUser();
        $this->_paymentMean = SK_Model_PaymentMean_Ccbill::createStatic(array(
            'user'           => $this->_user,
            'username'       => 'foo',
            'userpass'       => 'bar',
    ...
    public function testFindByUser() {
        $paymentMeanList = SK_Model_PaymentMean_Ccbill::findByUser($this->_user);
    ...
    public function testDelete() {
        ...
        new SK_Model_PaymentMean_Ccbill($this->_paymentMean->getId());
    }
}
